...
import RegistrationEmployer from "./RegesitrationEmployer";
...
const NavbarEmployer = () => {
  ...
  const handleLogout = async () => {
    try {
      const response = await axios.get("/logoutemployer");
    ...
    <div className={`flex flex-wrap items-center justify-between px-4 py-3`}>
      ...
      >
        {!isMobile && (
          ...
          <Link to={"/about-employer"}> <li className="font-semibold  text-md" >
              About
            </li></Link> 
